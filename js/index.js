...
function RegresarEstadoCuerpo(objeto)
{
...
function menu(opcion){
	...
	// Si pulsamos un bot—n del menu principal entramos en el else
		...
		addClass('li-menu-activo' , document.getElementById("ulMenu").getElementsByClassName("opt")[opcion]);
		...
		setTimeout(function() {
			removeClass('li-menu-activo' , document.getElementById("ulMenu").getElementsByClassName("opt")[opcion]);
		}, 300);
